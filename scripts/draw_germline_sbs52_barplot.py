...
def load_sbs52_counts(
    ...
    sbs96_counts = load_sbs96_counts(chrom_lst, vcf_path, ref_path, is_reference_sample)
...
def write_sbs52_counts(
    ...
    sbs52_counts = load_sbs52_counts(chrom_lst, vcf_path, ref_path, is_reference_sample)
    ...
    draw_sbs52_barplot(out_path, sample, pdf_path)
